...
if ($page === 'broker_earnings') {
    ...
    if ($result && $result->num_rows > 0) {
        ...
        while ($row = $result->fetch_assoc()) {
            ...
            $broker_earnings = number_format($row['broker_earnings'], 2);
            $delivery_earnings = number_format($row['delivery_earnings'], 2);
            $total_earnings = number_format($row['total_earnings'], 2);
            $content .= "<tr>
                <td>{$month}</td>
                <td>{$trades}</td>
